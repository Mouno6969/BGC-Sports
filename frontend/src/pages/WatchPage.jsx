// ---------------------------------------------------------------------------
// WatchPage — Full player page with HLS stream, channel info, and related
// channels sidebar. FoxSports-style layout.
// ---------------------------------------------------------------------------
          ...
          <div className="space-y-2 max-h-[calc(100vh-200px)] overflow-y-auto scrollbar-thin">
            {relatedChannels.map((ch, i) => (
              <Link
                ...
                className="flex items-center gap-3 rounded-xl border border-[var(--border-primary)] bg-[var(--bg-secondary)] p-3 transition-all hover:border-accent/30 hover:bg-[var(--bg-tertiary)]"
              >
                <div className="flex h-12 w-16 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-[var(--bg-tertiary)]">
                ...
                <svg className="h-4 w-4 shrink-0 text-[var(--text-muted)]" fill="currentColor" viewBox="0 0 24 24">
