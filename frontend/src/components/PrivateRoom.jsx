            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-center gap-2 pt-0.5">
                <button onClick={toggleMic} title={micMuted ? 'Unmute' : 'Mute'}
                  className={`flex h-9 w-9 items-center justify-center rounded-lg transition-all ${!micMuted ? 'bg-ink-600 text-white hover:bg-ink-500' : 'bg-red-500/20 text-red-400 ring-1 ring-red-500/30'}`}>
                  {!micMuted ? (
                    ...
                    <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15zM17 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2" /></svg>
                  )}
                </button>
                {callMode === 'video' && (
                  <button onClick={toggleCam} title={camOff ? 'Camera on' : 'Camera off'}
                    className={`flex h-9 w-9 items-center justify-center rounded-lg transition-all ${!camOff ? 'bg-ink-600 text-white hover:bg-ink-500' : 'bg-red-500/20 text-red-400 ring-1 ring-red-500/30'}`}>
                    <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      {!camOff
                        ? <path strokeLinecap="round" strokeLinejoin="round" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                ...
                <button onClick={leaveCall} title="Leave call"
                  className="flex h-9 w-9 items-center justify-center rounded-lg bg-red-500 text-white transition-all hover:bg-red-600 active:scale-95">
